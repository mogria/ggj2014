...
RocketOverlaySystem::RocketOverlaySystem(Rocket::Core::Context* context, Ogre::RenderWindow* window)
{
	mWindow = window;
	mContext = context;
}
...
RocketOverlaySystem::~RocketOverlaySystem()
{
}

// Called from Ogre before a queue group is rendered.
void RocketOverlaySystem::renderQueueStarted(Ogre::uint8 queueGroupId, const Ogre::String& invocation, bool& ROCKET_UNUSED(repeatThisInvocation))
{
...
void RocketOverlaySystem::renderQueueEnded(Ogre::uint8 ROCKET_UNUSED(queueGroupId), const Ogre::String& ROCKET_UNUSED(invocation), bool& ROCKET_UNUSED(repeatThisInvocation))
{
}


// Configures Ogre's rendering system for rendering Rocket.
void RocketOverlaySystem::ConfigureRenderSystem()
{
...
void RocketOverlaySystem::BuildProjectionMatrix(Ogre::Matrix4& projection_matrix)
{
	float z_near = -1;
	float z_far = 1;
